...
#include "SailPositionControllerGES.hh"
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
SailPositionControllerGES::~SailPositionControllerGES() = default;

/////////////////////////////////////////////////
SailPositionControllerGES::SailPositionControllerGES()
  : System(), dataPtr(std::make_unique<SailPositionControllerPrivate>())
{
}

/////////////////////////////////////////////////
void SailPositionControllerGES::Configure(
...
/////////////////////////////////////////////////
void SailPositionControllerGES::PreUpdate(
    const UpdateInfo &_info,
    EntityComponentManager &_ecm)
{
  GZ_PROFILE("SailPositionControllerGES::PreUpdate");
  ...
  // Adjustment to work with ROS controller and allow tacking:
...
GZ_ADD_PLUGIN(
    gz::sim::systems::SailPositionControllerGES,
    gz::sim::System,
    gz::sim::systems::SailPositionControllerGES::ISystemConfigure,
    gz::sim::systems::SailPositionControllerGES::ISystemPreUpdate)
